...
| `hosts/nixos-desktop/` | `nixos-desktop` | `x86_64-linux` | XFCE VM under VirtualBox (imports `modules/nixos/desktop/`) |
...
│   └── nixos-desktop/            #   XFCE VM — + generated hardware-configuration.nix
│
...
│       ├── desktop/              #     reusable XFCE + VM guest-tools layer
