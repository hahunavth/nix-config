...
flowchart TD
	...
	W --> SH[modules/shared<br/>cross-platform home core]
	NX --> SH
...
layers a host pulls in (`shared` = cross-platform home; `darwin`/`nixos` = platform
...
edit), `modules/shared/programs/` (the Atlassian trio), and `modules/darwin/homebrew/`.
